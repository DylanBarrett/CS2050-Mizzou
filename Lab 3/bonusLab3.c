...
void Search_Players(player*, int, int, int*);
...
do{
    ...
    Search_Players(player1, num_players, number, &successes);
 
 printf("\nTotal number of successful searches throughout the program = %d\n", successes);
...
void Search_Players(player* player1, int length, int number, int* successes)
{
    int i, count = 0;
